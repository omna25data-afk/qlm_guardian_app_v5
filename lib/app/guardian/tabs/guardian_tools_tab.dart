      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildFeeRow('توثيق عقد زواج', '750 ر.ي'),
            _buildFeeRow('توثيق عقد طلاق', '500 ر.ي'),
            _buildFeeRow('توثيق رجعة', '350 ر.ي'),
            _buildFeeRow('توثيق خلع', '500 ر.ي'),
            _buildFeeRow('إثبات حالة', '400 ر.ي'),
            const SizedBox(height: 16),
            Text(
