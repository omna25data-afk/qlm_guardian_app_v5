...
class GuardianRecordBookEntriesScreen extends ConsumerStatefulWidget {
  final int contractTypeId;
  final String contractTypeName;
  final int bookNumber;

  const GuardianRecordBookEntriesScreen({
    super.key,
  ...
  @override
  ConsumerState<GuardianRecordBookEntriesScreen> createState() =>
      _GuardianRecordBookEntriesScreenState();
}

class _GuardianRecordBookEntriesScreenState
    extends ConsumerState<GuardianRecordBookEntriesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final entriesAsync = ref.watch(guardianEntriesByBookProvider(args));
      ...
      body: entriesAsync.when(
        ...
        error: (error, _) => Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () =>
                    ref.refresh(guardianEntriesByBookProvider(args).future),
                child: const Text(
                  'إعادة المحاولة',
        ...
        data: (entries) {
          ...
          return RefreshIndicator(
            onRefresh: () async {
              ref.invalidate(guardianEntriesByBookProvider(args));
            },
              ...
              itemBuilder: (context, index) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    // Re-use current entry cards from shared generic features directory
                    ...yearEntries.map(
                      (entry) => GuardianEntryCard(entry: entry),
                    ),
