...
class LicenseHistoryScreen extends ConsumerStatefulWidget {
  final int guardianId;
  final String guardianName;

  const LicenseHistoryScreen({
    super.key,
  ...
  @override
  ConsumerState<LicenseHistoryScreen> createState() =>
      _LicenseHistoryScreenState();
}

class _LicenseHistoryScreenState extends ConsumerState<LicenseHistoryScreen> {
  ...
  Future<void> _fetchHistory() async {
    try {
      final history = await ref
          ...
          .fetchLicenseHistory(widget.guardianId);
      if (mounted) {
        setState(() {
          _history = history;
          _isLoading = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'سجل تجديدات الرخصة - ${widget.guardianName}',
