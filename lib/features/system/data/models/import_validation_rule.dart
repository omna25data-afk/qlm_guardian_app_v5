class ImportValidationRule {
  ...
  factory ImportValidationRule.fromJson(Map<String, dynamic> json) {
    return ImportValidationRule(
      ...
      priority: json['priority'] != null ? (json['priority'] is int ? json['priority'] : int.tryParse(json['priority'].toString()) ?? 0) : 0,
      condition: json['condition'] ?? null,
      metadata: json['metadata'] ?? null,
      userId: json['user_id'] != null ? (json['user_id'] is int ? json['user_id'] : int.tryParse(json['user_id'].toString()) ?? null) : null,
      isSystem: json['is_system'] == 1 || json['is_system'] == true || json['is_system'] == '1',
