class RecordBookProcedure {
  ...
  factory RecordBookProcedure.fromJson(Map<String, dynamic> json) {
    return RecordBookProcedure(
      ...
      startPage: json['start_page'] != null ? (json['start_page'] is int ? json['start_page'] : int.tryParse(json['start_page'].toString()) ?? null) : null,
      endPage: json['end_page'] != null ? (json['end_page'] is int ? json['end_page'] : int.tryParse(json['end_page'].toString()) ?? null) : null,
      startConstraintNumber: json['start_constraint_number'] != null ? (json['start_constraint_number'] is int ? json['start_constraint_number'] : int.tryParse(json['start_constraint_number'].toString()) ?? null) : null,
      endConstraintNumber: json['end_constraint_number'] != null ? (json['end_constraint_number'] is int ? json['end_constraint_number'] : int.tryParse(json['end_constraint_number'].toString()) ?? null) : null,
      performedBy: json['performed_by'] != null ? (json['performed_by'] is int ? json['performed_by'] : int.tryParse(json['performed_by'].toString()) ?? 0) : 0,
