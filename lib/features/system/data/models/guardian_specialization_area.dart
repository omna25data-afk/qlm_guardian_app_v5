class GuardianSpecializationArea {
  ...
  factory GuardianSpecializationArea.fromJson(Map<String, dynamic> json) {
    return GuardianSpecializationArea(
      ...
      isMain: json['is_main'] == 1 || json['is_main'] == true || json['is_main'] == '1',
      isDirect: json['is_direct'] == 1 || json['is_direct'] == true || json['is_direct'] == '1',
      isAdditional: json['is_additional'] == 1 || json['is_additional'] == true || json['is_additional'] == '1',
