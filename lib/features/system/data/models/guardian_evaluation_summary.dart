  ...
  factory GuardianEvaluationSummary.fromJson(Map<String, dynamic> json) {
    return GuardianEvaluationSummary(
      ...
      evaluationPeriodId: json['evaluation_period_id'] != null
          ...
          : 0,
      registersSummaryScore: json['registers_summary_score'] != null
          ? (json['registers_summary_score'] is num
                ? json['registers_summary_score'].toDouble()
                : double.tryParse(json['registers_summary_score'].toString()) ??
                      null)
          : null,
      salesRegisterScore: json['sales_register_score'] != null
          ? (json['sales_register_score'] is num
                ? json['sales_register_score'].toDouble()
                : double.tryParse(json['sales_register_score'].toString()) ??
                      null)
          : null,
      licenseRenewalComplianceScore:
          json['license_renewal_compliance_score'] != null
          ? (json['license_renewal_compliance_score'] is num
                ? json['license_renewal_compliance_score'].toDouble()
                : double.tryParse(
                        json['license_renewal_compliance_score'].toString(),
                      ) ??
                      null)
          : null,
      reputationBehaviorScore: json['reputation_behavior_score'] != null
          ? (json['reputation_behavior_score'] is num
                ? json['reputation_behavior_score'].toDouble()
                : double.tryParse(
                        json['reputation_behavior_score'].toString(),
                      ) ??
                      null)
          : null,
      dutiesComplianceScore: json['duties_compliance_score'] != null
          ? (json['duties_compliance_score'] is num
                ? json['duties_compliance_score'].toDouble()
                : double.tryParse(json['duties_compliance_score'].toString()) ??
                      null)
          : null,
      totalScore: json['total_score'] != null
          ? (json['total_score'] is num
                ? json['total_score'].toDouble()
                : double.tryParse(json['total_score'].toString()) ?? null)
          : null,
