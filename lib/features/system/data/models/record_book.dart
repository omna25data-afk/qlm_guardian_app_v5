  ...
  factory RecordBook.fromJson(Map<String, dynamic> json) {
    return RecordBook(
      ...
      recordBookTypeId: json['record_book_type_id'] != null
          ...
          : null,
      recordBookTemplateId: json['record_book_template_id'] != null
          ? (json['record_book_template_id'] is int
                ? json['record_book_template_id']
                : int.tryParse(json['record_book_template_id'].toString()) ??
                      null)
          : null,
      name: json['name'] ?? '',
      ...
      legitimateGuardianId: json['legitimate_guardian_id'] != null
          ? (json['legitimate_guardian_id'] is int
                ...
                : int.tryParse(json['legitimate_guardian_id'].toString()) ??
                      null)
          : null,
      bookNumber: json['book_number'] != null
          ? (json['book_number'] is int
                ? json['book_number']
                : int.tryParse(json['book_number'].toString()) ?? 0)
          : 0,
      ...
      createdBy: json['created_by'] != null
          ...
          : 0,
      status: json['status'] ?? '',
      issuedProcedureId: json['issued_procedure_id'] != null
          ? (json['issued_procedure_id'] is int
                ? json['issued_procedure_id']
                : int.tryParse(json['issued_procedure_id'].toString()) ?? null)
          : null,
      currentOpeningProcedureId: json['current_opening_procedure_id'] != null
          ? (json['current_opening_procedure_id'] is int
                ? json['current_opening_procedure_id']
                : int.tryParse(
                        json['current_opening_procedure_id'].toString(),
                      ) ??
                      null)
          : null,
