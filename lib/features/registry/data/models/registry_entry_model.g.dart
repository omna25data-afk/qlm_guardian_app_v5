...
RegistryEntryModel _$RegistryEntryModelFromJson(Map<String, dynamic> json) =>
    RegistryEntryModel(
      ...
      deliveryStatusLabel: json['delivery_status_label'] as String?,
      deliveryStatusColor: json['delivery_status_color'] as String?,
      ...
      subtype1: (json['subtype_1'] as num?)?.toInt(),
      subtype2: (json['subtype_2'] as num?)?.toInt(),
      ...
      otherFeeAmount: (json['other_fee_amount'] as num?)?.toDouble(),
      ...
      exemptionReason: json['exemption_reason'] as String?,
...
Map<String, dynamic> _$RegistryEntryModelToJson(
  ...
  'delivery_status_label': instance.deliveryStatusLabel,
  'delivery_status_color': instance.deliveryStatusColor,
  ...
  'other_fee_amount': instance.otherFeeAmount,
  ...
  'exemption_reason': instance.exemptionReason,
